...
import { EnumAppDatasetSource, EnumAppDatasetProcessType } from '.';
import { EnumAppDatasetColType, EnumAppDatasetDataType } from './enums';
...
export interface AppDataset {
  ...
  processType: EnumAppDatasetProcessType;
